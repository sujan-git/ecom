...
<html lang="en">
<head>
    <title>{{isset($title)?$title:'Cozastore| Online Shopping Platform'}}</title>
    <meta charset="UTF-8">
                        ...
                        <ul class="main-menu">
                            ...
                            <li class="active-menu">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="{{route('category-shop',$category->slug)}}">{{$category->title}}</a></li>
                                    @endforeach
                                </ul>
                                @endif
                            </li>
                    ...
                    <div class="col-md-6 col-lg-7 p-b-30">
                        <div class="p-l-25 p-r-30 p-lr-0-lg">
                            <div class="wrap-slick3 flex-sb flex-w">
                                ...
                                <div class="slick3 gallery-lb" id="productGallery">
...
<!--===============================================================================================
    <script src="{{asset('frontend/customjs/cart-panel.js')}}"></script>  <!-Added To display cart-->
<!--===============================================================================================-->
