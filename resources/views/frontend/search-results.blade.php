...
@section('content')
  @if(!$products->isEmpty())  
   ...
   <!-- Product -->
                ...
                <div class="dis-none panel-filter w-full p-t-10">
                    <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                        ...
                        <div class="filter-col2 p-r-15 p-b-27">
                            ...
                            <ul>
                                <li class="p-b-6">
                                    <a href="{{ url('/search?').(isset($query_string) ? $query_string : '') }}" class="filter-link stext-106 trans-04 filter-link-active">
                                        All
                                    </a>
                                </li>
                                ...
                                <li class="p-b-6">
                                    <a href="{{ url('/search?'.$query_string."&price=100000-above") }}" class="filter-link stext-106 trans-04">
                                        Rs 100000.00+
                                    </a>
                                </li>
                            </ul>
    ...
    <div class="container">
        <div class="row">
            <h1>No products found for this section</h1>
        </div>
    </div>
    @endif
@endsection      
